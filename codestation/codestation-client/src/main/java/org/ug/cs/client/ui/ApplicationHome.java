...
public class ApplicationHome {
	...
	private void initialize() {
			...
			groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(lblLoggedInAs, Alignment.TRAILING))
					.addContainerGap())
		);
		...
		gl_mediaPanel.setHorizontalGroup(
			gl_mediaPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_mediaPanel.createSequentialGroup()
					.addContainerGap()
					.addComponent(lblTitle)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(titleField, GroupLayout.PREFERRED_SIZE, 142, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(btnSave)
					.addContainerGap(320, Short.MAX_VALUE))
		);
		gl_mediaPanel.setVerticalGroup(
			gl_mediaPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_mediaPanel.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_mediaPanel.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblTitle)
